...
import com.code.pep.pep_pro_servlet.d_Service_Old.TicketServiceOld;
...
@WebServlet("/ticketold")
public class TicketServletOld extends HttpServlet {

    private final TicketServiceOld ticketService = TicketServiceOld.getInstance();
